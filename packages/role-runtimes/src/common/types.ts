 ...
 *
 * No imports from `@keni/server` or `@keni/role-runtimes/common/...` —
 * these types are the public surface of the package, re-exported by
 * `packages/role-runtimes/src/main.ts` (per `design.md` Decision 1).
 *
 * @module
 */
